...
//    public AutoSuggest(String name, String Midpoint, float friendWD){
//
//        this.name = name;
...
//    }
    ...
    public AutoSuggest(String id, String name, String email, String DOB, double latitude, double longitude,String Midpoint, float friendWD, float yourWD, int totalWD,String meetingTime){
